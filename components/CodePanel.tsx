...
export const CodePanel: React.FC<{ 
  ...
  const updateCalculationSteps = (
    ...
    if (damping === 0) {
      ...
      // Step 5: Position update (Euler method)
      const angleChange = prevVelocity * effectiveDT
      const newAngle = prevAngle + angleChange
      steps.push({
        description: "Update angle position (Euler method)",
      ...
      steps.push({
        description: "Using 4th-order Runge-Kutta integration (RK4)",
        equation: "RK4 method",
      ...
      steps.push({
        description: "Final RK4 integration result",
